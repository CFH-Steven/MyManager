...
@implementation UIImageView (FHCornerRadius)
...
- (instancetype)initWithRoundingRectImageView {
    self = [super init];
    if (self) {
        [self fh_cornerRadiusRoundingRect];
    }
    return self;
}
...
- (instancetype)initWithCornerRadiusAdvance:(CGFloat)cornerRadius rectCornerType:(UIRectCorner)rectCornerType {
    self = [super init];
    if (self) {
        [self fh_cornerRadiusAdvance:cornerRadius rectCornerType:rectCornerType];
    }
    return self;
}
